...
export class CwbodService {
  ...
  apiKey = 'CWB-0D517A97-D4ED-47B2-921C-1649C8F23191'; // <-- Enter your own key here!
  ...
  getAllCity() {
    let cityBy7Days: CityBy7Days[] = [];
    return this.http.get(`${this.url}F-D0047-091?Authorization=${this.apiKey}&elementName=MinT,MaxT,Wx`).pipe(
      map(result => {
        return this.mapToCityBy7Days(cityBy7Days, result);
      })
    )
